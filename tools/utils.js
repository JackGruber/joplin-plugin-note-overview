...
function getJPLFileName() {
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      ...
      return [2 /*return*/, manifest.id + ".jpl"];
    });
  });
}
exports.getJPLFileName = getJPLFileName;
function updateChangelog(version) {
  return __awaiter(this, void 0, void 0, function () {
    var changelog, data;
    return __generator(this, function (_a) {
      changelog = path.resolve(path.join(__dirname, "..", "CHANGELOG.md"));
      data = fs.readFileSync(changelog, { encoding: "utf8", flag: "r" });
...
function setPluginVersion(version) {
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      ...
      manifestFile = path.resolve(path.join(__dirname, "../src/manifest.json"));
      manifest = require(manifestFile);
        ...
        case 0:
          ...
          return [
            ...
            execCommand_1.execCommand(
              "npm version " +
                type +
                " -git-tag-version false -commit-hooks false",
...
exports.runNpmVersion = runNpmVersion;
